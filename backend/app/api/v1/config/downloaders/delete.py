...
@router.delete("/config/downloaders/{downloader_id}", response_model=OperationResponse)
async def delete_downloader(downloader_id: str) -> OperationResponse:
    """Internal helper."""
    settings_service.delete_downloader(downloader_id)
