    ...
    def _build_placeholder_profile(
        ...
        *,
        ...
        return ManagedMediaProfile(
            ...
            rating_count=existing.rating_count if existing else None,
            vote_average=existing.vote_average if existing else None,
            vote_count=existing.vote_count if existing else None,
            rating_source=existing.rating_source if existing else None,
            douban_vote_average=existing.douban_vote_average if existing else None,
            douban_rating_count=existing.douban_rating_count if existing else None,
